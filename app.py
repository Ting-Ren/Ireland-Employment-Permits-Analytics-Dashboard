...
# ===================================================
with streamlit_analytics.track(data_file_path="data/analytics_history.json"):
    ...
    with grid_bottom:
        ...
        with grid_ctrl1:
            year_search = st.selectbox("Isolate Grid Year:", ["All Years"] + [str(y) for y in all_years], key="grid_year_select")
        with grid_ctrl2:
            emp_search = st.text_input("Isolate Grid Employer Name:", placeholder="Type to filter rows below...", key="grid_employer_input")
